...
public static class DictionaryGlobals
{
    ...
    private static readonly XmlDictionary s_dictionary = new XmlDictionary(69);
    ...
    public static readonly XmlDictionaryString ArrayOfAnyTypeLocalName = s_dictionary.Add("ArrayOfAnyType");
    public static readonly XmlDictionaryString ArraySchemaNamespace = s_dictionary.Add("http://schemas.microsoft.com/2003/10/Serialization/Arrays");
    
    // 65
    public static readonly XmlDictionaryString XmlElementLocalName = s_dictionary.Add("XmlElement");
    public static readonly XmlDictionaryString SystemXmlNamespace = s_dictionary.Add("http://schemas.datacontract.org/2004/07/System.Xml");
    public static readonly XmlDictionaryString ArrayOfXmlNodeLocalName = s_dictionary.Add("ArrayOfXmlNode");
    public static readonly XmlDictionaryString ArrayOfXmlNodeNamespace = s_dictionary.Add("http://schemas.datacontract.org/2004/07/");
}