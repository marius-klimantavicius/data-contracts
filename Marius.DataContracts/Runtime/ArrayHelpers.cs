...
{
    internal const int XmlDictionaryReaderMaxInitialArrayLength = 65535;
    ...
    public TArray[] ReadArray(XmlDictionaryReader reader, TArgument localName, TArgument namespaceUri, int maxArrayLength)
    {
        ...
        if (reader.TryGetArrayLength(out var count))
        {
            ...
            if (count > XmlDictionaryReaderMaxInitialArrayLength)
                count = XmlDictionaryReaderMaxInitialArrayLength;
        }
        else
        {
            count = 32;
        ...
        while (true)
        {
            ...
            {
                var actual = ReadArray(reader, localName, namespaceUri, array, read, array.Length - read);
                if (actual == 0)
                    break;
        ...
        {
            var newArray = new TArray[totalRead];
            var offset = 0;
    ...
    public void WriteArray(XmlDictionaryWriter writer, string prefix, TArgument localName, TArgument namespaceUri, XmlDictionaryReader reader)
    {
        if (reader.TryGetArrayLength(out var count))
            ...
            count = 256;
        var array = new TArray[count];
        while (true)
        {
            var actual = ReadArray(reader, localName, namespaceUri, array, 0, array.Length);
            if (actual == 0)
                break;
...
public sealed class BooleanArrayHelperWithString : ArrayHelper<string, bool>
{
...
public sealed class BooleanArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, bool>
{
...
public sealed class Int16ArrayHelperWithString : ArrayHelper<string, short>
{
...
public sealed class Int16ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, short>
{
...
public sealed class Int32ArrayHelperWithString : ArrayHelper<string, int>
{
...
public sealed class Int32ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, int>
{
...
public sealed class Int64ArrayHelperWithString : ArrayHelper<string, long>
{
...
public sealed class Int64ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, long>
{
...
public sealed class SingleArrayHelperWithString : ArrayHelper<string, float>
{
...
public sealed class SingleArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, float>
{
...
public sealed class DoubleArrayHelperWithString : ArrayHelper<string, double>
{
...
public sealed class DoubleArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, double>
{
...
public sealed class DecimalArrayHelperWithString : ArrayHelper<string, decimal>
{
...
public sealed class DecimalArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, decimal>
{
...
public sealed class DateTimeArrayHelperWithString : ArrayHelper<string, DateTime>
{
...
public sealed class DateTimeArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, DateTime>
{
...
public sealed class GuidArrayHelperWithString : ArrayHelper<string, Guid>
{
...
public sealed class GuidArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, Guid>
{
...
public sealed class TimeSpanArrayHelperWithString : ArrayHelper<string, TimeSpan>
{
...
public sealed class TimeSpanArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, TimeSpan>
{
